...
2. **Research seeding** — when a heavy research starts (see [backlog](../principles/research-backlog.md)), pull its source base from here instead of searching from zero.
...
- [principles/vision-ai-assisted-cto.md](../principles/vision-ai-assisted-cto.md) — why these categories
