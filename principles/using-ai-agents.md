...
- [collaboration-principles.md](collaboration-principles.md) — the contract the team implements
- [consultant-stance.md](consultant-stance.md) — the toolkit the agents apply
